...
import instructorImage from "../assets/profile.jfif";
    ...
    <div className="instructor-page">
      <div className="instructor-card">
        ...
        <div className="instructor-info">
          <h1>Sainath Dattatray Balkawade</h1>
          <h4>Your Instructor</h4>
          <p>
            Hello! I'm Sainath Balkawade, a passionate MERN stack developer with
            a love for teaching and building scalable, robust applications. With
